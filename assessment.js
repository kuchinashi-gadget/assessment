(function(){
    ...
    const useNmaeInput = document.getElementById('user-name');
    ...
    assessmentButton.onclick = () => {
        //console.log('ボタンが押されました');
        const userName = useNmaeInput.value;
